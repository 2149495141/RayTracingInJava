...
import static RTNextWeek.RTUtil.degrees_to_radians;
import static RTNextWeek.RTUtil.infinity;
...
public class Rotate implements HitTable{
    ...
    public boolean hit(Ray r, Interval t, HitRecord rec) {
        ...
        origin[r0] = cos_theta*origin[r0] - sin_theta*origin[r1];
        origin[r1] = sin_theta*origin[r0] + cos_theta*origin[r1];

        direction[r0] = cos_theta*direction[r0] - sin_theta*direction[r1];
        direction[r1] = sin_theta*direction[r0] + cos_theta*direction[r1];
        ...
        p[r0] =  cos_theta*p[r0] + sin_theta*p[r1];
        p[r1] = -sin_theta*p[r0] + cos_theta*p[r1];

        double[] normal = rec.normal.toArray();
        normal[r0] =  cos_theta*normal[r0] + sin_theta*normal[r1];
        normal[r1] = -sin_theta*normal[r0] + cos_theta*normal[r1];
