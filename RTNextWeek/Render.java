...
import RTNextWeek.HitTable.HitTable;
        ...
        JFrame window = new JFrame("Ray tracing in Java"){
            ...
            public void paint(Graphics g) {
                ...
                for (int s=0; s < spp; ++s){
                    ...
                    log_info.delete(0,log_info.length());
                    System.out.println(log_info.append("采样数:").append(s+1).append(" | ").append("耗时:")
                                        .append((double)(System.currentTimeMillis()-start_time)/1000).append('s'));
                }
            }
        };
